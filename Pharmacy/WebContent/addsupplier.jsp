		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="AddSupplierController"
						method="post">
						<fieldset>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Supplier
									Name</label>
								<div class="col-md-6">
									<input id="name" name="sname" type="text" placeholder=" Sagar"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="smobile" type="text"
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="semail" type="text"
										placeholder="sagar@gmail.com" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Supplier
									Address</label>
								<div class="col-md-6">
									<input id="name" name="saddress" type="text" placeholder="Pune"
										class="form-control">
								</div>
							</div>
