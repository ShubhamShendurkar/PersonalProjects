...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<%
		...
		List<Supplier> ae = bm.viewSupplier();
					...
					<table data-toggle="table" data-url="tables/data1.json"
						...
						<c:forEach items="${sessionScope.list1}" var="l">
							<tr>
								...
								<td><center><a href="UpdateSupplierController?id=${l.supid}" style="color: blue;">Update</a></center></td>
								<td><center><a href="DeleteSupplierController?id=${l.supid}" style="color: blue;">Delete</a></center></td>
